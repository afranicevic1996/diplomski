      ...
      <div class="form-row center">
	      <div class="form-group col-md-12">
      		...
      		<div class="input-group mb-2">
        		...
        		<?php if(session()->has('tekst')): ?>
        			<input type="text" class="form-control search" id="inlineFormInputGroup" value="<?php echo e(session()->get('tekst')); ?>" placeholder="Upišite naziv proizvoda">
        		<?php else: ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
  	...
  	<?php if(session()->has('tekst')): ?>
  		saljiUpit("<?php echo e(session()->get('tekst')); ?>", "/getProductByString/", "get");
  	<?php endif; ?>
  	...
  	function saljiUpit(vrijednost, urlPoziva, method){
	    ...
	    request.done(function (response, textStatus, jqXHR){
	        ...
	        for(i = 0; i < proizvodi.length; i++){
				...
				//dio za formu
				editForma = "<form id='formaUpdate"+id+"' action='/editProduct' method='post'><input name='_token' value='<?php echo e(csrf_token()); ?>' type='hidden'><input type='hidden' name='id' value='"+id+"'><input name='vrijednost' value='"+vrijednost+"' type='hidden'></form>";
...
</html><?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/editProduct.blade.php ENDPATH**/ ?>