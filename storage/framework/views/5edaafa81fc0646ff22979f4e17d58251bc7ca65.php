      ...
      <div class="list-group">
        ...
        <div class="collapse" id="collapseExample">
          <div class="card card-body komp">
            <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($kate->komponenta): ?>
                <?php if($trenutnaKate == $kate->id): ?>
                  <a href="/products?kategorija=<?php echo e($kate->id); ?>" style="height: 40px; padding: 10px 15px;" class="list-group-item list-group-item-action active">
                  <i class="fas fa-chevron-right"></i> <?php echo e($kate->naziv); ?></a>
                <?php else: ?>
                  <a href="/products?kategorija=<?php echo e($kate->id); ?>" style="height: 40px; padding: 10px 15px;" class="list-group-item list-group-item-action">
                  <i class="text-primary fas fa-chevron-right"></i> <?php echo e($kate->naziv); ?></a>         
                <?php endif; ?>        
              <?php endif; ?>
        ...
        <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if(!$kate->komponenta): ?>
            <?php if($trenutnaKate == $kate->id): ?>
              <a href="/products?kategorija=<?php echo e($kate->id); ?>" class="list-group-item list-group-item-action active"><?php echo e($kate->naziv); ?></a>
            <?php else: ?>
              <a href="/products?kategorija=<?php echo e($kate->id); ?>" class="list-group-item list-group-item-action"><?php echo e($kate->naziv); ?></a>
            <?php endif; ?>
          <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    ...
    <div class="col-lg-8">
      <!--<center><legend>-->
        ...
        <?php else: ?>
          <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($trenutnaKate == $kate->id): ?>
              <div class="naziv"><?php echo e($kate->naziv); ?></div>
            <?php endif; ?>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
      <!--</legend></center>-->
      <div class="ponuda">
        <table class="table table-hover shopping-cart-wrap">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <figure class="media">
                  <div class="img-wrap"><img src="<?php echo e($link); ?>" class="img-thumbnail img-sm" style="margin-right: 5px"></div>
                  <figcaption class="media-body">
                    <h6 class="title text-truncate"><a href="/product/<?php echo e($proizvod->id); ?>" class="inherit"><?php echo e($proizvod->naziv); ?></a></h6>
                  </figcaption>
                </figure> 
              </td>
              <td>
                <?php echo e($proizvod->cijena); ?> Kn
              </td>
              <td>
              <?php if($proizvod->dostupnost): ?>
              ...
              <td class="text-right">
                <?php if($proizvod->dostupnost): ?>
                  <form style="display: inline;" action="/addToCart/<?php echo e($proizvod->id); ?>" method="post">
                   <?php echo csrf_field(); ?>
                   <input type="hidden" id="item<?php echo e($proizvod->id); ?>" name="kolicina" value="1">
                   <input type="hidden" name="cijena" value="<?php echo e($proizvod->cijena); ?>">
                   <button title="" id="buy<?php echo e($proizvod->id); ?>" class="btn btn-outline-success" data-toggle="tooltip" data-original-title="Save to Wishlist"> <i class="fas fa-shopping-cart"></i></button>
                  </form>
                <?php else: ?>
                ...
                <?php endif; ?>
                <a href="/product/<?php echo e($proizvod->id); ?>" class="btn btn-outline-secondary btn-round">Detalji <i class="fas fa-arrow-right"></i></a>
              </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </tbody>
        ...
        <hr>
        <div>
          <?php echo e($proizvodi->appends($_GET)->links()); ?>
...
cijenaSlider(0, 0);
  var i = 0;
  <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($trenutnaKate == $kate->id && $kate->komponenta == 1): ?>
      if(i == 0){
...
</html><?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/products.blade.php ENDPATH**/ ?>