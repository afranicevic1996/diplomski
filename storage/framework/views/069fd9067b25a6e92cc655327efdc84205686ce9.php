    ...
    <div class="col-lg-10"><!-- col-lg-10 -->
      ...
      <div class="deleteFormeDiv">
        <?php $__currentLoopData = $akcije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $akcija): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <form id="formaDel<?php echo e($akcija->productID); ?>" style="display: inline;" action="/adminPanel/posebneAkcije" method="post"><?php echo csrf_field(); ?> <?php echo method_field("DELETE"); ?>
            <input type="hidden" id="" name="productID" value="<?php echo e($akcija->productID); ?>"> 
         </form>
      ...
      <?php $link = URL::asset($akcija->fileName); ?>
      	<tr>
      		<td><img src='<?php echo e($link); ?>' class="d-block w-100" alt="..."></td>
      		<td><a class="link" href='/product/<?php echo e($akcija->productID); ?>'><?php echo e($proizvodi[$akcija->productID]->naziv); ?></a></td>
      		<td>
      			<form method="post" id="forma<?php echo e($akcija->productID); ?>" enctype="multipart/form-data" action="/adminPanel/posebneAkcije">
      				<?php echo csrf_field(); ?> <?php echo method_field("POST"); ?>
      				<input type="hidden" name="productID" value="<?php echo e($akcija->productID); ?>">
      				<input type="file" data-akcija="update" class="slike" name="slika">
      			</form>
      		</td>
      		<td class="text-right">
      			<button type="button" data-toggle="modal" data-target="#exampleModal" data-akcija="delete" data-user="<?php echo e($akcija->productID); ?>" class="btn btn-outline-danger btn-round"> </i><i class="far fa-trash-alt"></i></button>
      		</td>
      	</tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/posebneAkcije.blade.php ENDPATH**/ ?>