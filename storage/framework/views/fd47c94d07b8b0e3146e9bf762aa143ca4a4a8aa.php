        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <select name="kategorija" class="podaci browser-default custom-select" required>
              ...
              <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($kat->id); ?>"><?php echo e($kat->naziv); ?></option>
...
<?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/addProduct.blade.php ENDPATH**/ ?>