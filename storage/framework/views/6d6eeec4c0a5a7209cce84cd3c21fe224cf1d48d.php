  ...
  <div class="row">
    ...
    <div class="col-lg-2">
      <div class="list-group">
        <a href="" class="list-group-item list-group-item-dark inactiveLink">Prijavljeni ste kao: <?php echo e(session()->get('username')); ?></a>
    ...
    <div class="col-lg-10"><!-- col-lg-10 -->
      <?php if(session()->has('status')): ?>
        <?php if(!session()->get('error')): ?>
          <div class="alert alert-success" role="alert">
            <center><?php echo e(session()->get('status')); ?></center>
          </div>
        <?php else: ?>
      ...
      <tr>
        <form id="formaUpdate<?php echo e($user->id); ?>" action="/updateUser" method="post">
        <?php echo csrf_field(); ?>
        <input type="hidden" id="" name="id" value="<?php echo e($user->id); ?>">
        <td>
          <input type="text" id="" name="username" value="<?php echo e($user->username); ?>" placeholder="Korisnik" class="form-control"> 
        </td>
        <td>
          <input type="text" id="" name="ime" value="<?php echo e($user->ime); ?>" placeholder="Ime" class="form-control">
        </td>
        <td>
          <input type="text" id="" name="prezime" value="<?php echo e($user->prezime); ?>" placeholder="Prezime" class="form-control">
        </td>
        <td> 
          <input type="text" id="" name="email" value="<?php echo e($user->email); ?>" placeholder="Email" class="form-control">
        </td>
        <td> 
          <input id="" name="telefon" type="number" min="0" oninput="validity.valid||(value='');" value="<?php echo e($user->telefon); ?>" placeholder="Telefon" class="form-control">
        </td>
        <td> 
          <input type="text" id="" name="adresa" value="<?php echo e($user->adresa); ?>" placeholder="Adresa" class="form-control">
        </td>
        <td> 
          <input id="" name="pbroj" type="number" min="0" oninput="validity.valid||(value='');" value="<?php echo e($user->pbroj); ?>" placeholder="Poštanski broj" class="form-control">
        </td>
        <td class="text-right">
          <button type="button" data-toggle="modal" data-target="#exampleModal" data-akcija="update" data-user="<?php echo e($user->id); ?>" class="btn btn-outline-success btn-round"> <i class="far fa-save"></i></a></button>
          </form>
          <form id="formaDel<?php echo e($user->id); ?>" style="display: inline;" action="/deleteUser" method="post">
            <?php echo csrf_field(); ?>
            <input type="hidden" id="" name="id" value="<?php echo e($user->id); ?>">
            <button type="button" data-toggle="modal" data-target="#exampleModal" data-akcija="delete" data-user="<?php echo e($user->id); ?>" class="btn btn-outline-danger btn-round"> </i><i class="far fa-trash-alt"></i></button>
          </form>
        </td>
      </tr>
...
<?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/adminPanel.blade.php ENDPATH**/ ?>