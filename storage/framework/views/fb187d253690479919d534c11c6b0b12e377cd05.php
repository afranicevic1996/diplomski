    ...
    <div class="col-lg-10"><!-- col-lg-10 -->
      ...
      <div class="deleteFormeDiv">
        <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <form id="formaDel<?php echo e($kate->id); ?>" style="display: inline;" action="/adminPanel/editKategorije" method="post"><?php echo csrf_field(); ?> <?php echo method_field("DELETE"); ?>
            <input type="hidden" id="" name="id" value="<?php echo e($kate->id); ?>"> 
         </form>
      ...
      <div class="updateFormeDiv">
        <?php $__currentLoopData = $kategorije; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <form id="formaUpdate<?php echo e($kate->id); ?>" action="/adminPanel/editKategorije" method="post"><?php echo csrf_field(); ?> <?php echo method_field("POST"); ?>
          </form>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
      ...
      <tr>
        <td>
          <input type="hidden" id="" name="id" form="formaUpdate<?php echo e($kate->id); ?>" value="<?php echo e($kate->id); ?>" placeholder="Korisnik" class="form-control">
          <b><?php echo e($kate->id); ?></b> 
        </td>
        <td>
          <input type="text" id="" form="formaUpdate<?php echo e($kate->id); ?>" name="naziv" value="<?php echo e($kate->naziv); ?>" placeholder="Naziv" class="form-control" required>
        </td>
        <td class="text-right">
          <button type="button" data-toggle="modal" data-target="#exampleModal" data-akcija="update" data-user="<?php echo e($kate->id); ?>" class="btn btn-outline-success btn-round"> <i class="far fa-save"></i></a></button>
          <button type="button" data-toggle="modal" data-target="#exampleModal" data-akcija="delete" data-user="<?php echo e($kate->id); ?>" class="btn btn-outline-danger btn-round"> </i><i class="far fa-trash-alt"></i></button>
        </td>
      </tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <tr>
...
</html><?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/editKategorije.blade.php ENDPATH**/ ?>