  ...
  <div class="col-lg-12">
	...
	<div class="tab-content" id="myTabContent">
	  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
	  	...
	  	<h4>Uredite košaricu</h4>
	    <?php if(!count(session()->get('kosarica'))): ?>
	    ...
	    <table class="table table-hover shopping-cart-wrap">
	          ...
	          <td>
	            <figure class="media">
	              ...
	              <figcaption class="media-body">
	                <h6 class="title text-truncate"><?php echo e($item[0]->naziv); ?></h6>
	              </figcaption>
	            </figure> 
	          </td>
	          <td>
	            <form style="display: inline;" action="/updateKolicina/<?php echo e($item[0]->id); ?>" method="post" class="forma<?php echo e($item[0]->id); ?>">
	              <?php echo csrf_field(); ?>
	              <input name="kolicina" type="number" min="1" oninput="validity.valid||(value='');" value="<?php echo e($proizvodi[$i++]['kolicina']); ?>" placeholder="Količina" class="form-control kolicina" required>
	            </form>
	          </td>
	          <td>
	            <div class="price-wrap"> 
	              <var class="price"><?php echo e($item[0]->cijena); ?> Kn</var> <br>
	              <small class="text-muted"></small> 
	            </div>
	          </td>
	          <td class="text-right">
	            <a href="/product/<?php echo e($item[0]->id); ?>" class="btn btn-outline-secondary btn-round">Detalji <i class="fas fa-arrow-right"></i></a>
	            <form style="display: inline;" action="/removeFromCart/<?php echo e($item[0]->id); ?>" method="post">
	              <?php echo csrf_field(); ?>
	      ...
	      <tr>
	        ...
	        <td></td>
	        <td></td>
	        <td class="text-right"><?php echo e($ukupnaCijena); ?> Kn</td>
	      </tr>
	      <tr>
	        <tr scope="row"></tr>
	        <td></td>
	  ...
	  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
	  	...
	  	<h4>Molimo vas upišite potrebne osobne podatke!</h4>
		  ...
		  <div class="form-row">
		    <div class="form-group col-md-6">
		      ...
		      <input id="ime" name="ime" type="text" value="<?php echo e($userInfo->ime); ?>" placeholder="Ime" class="form-control" required>
		    </div>
		    <div class="form-group col-md-6">
		      <label for="prezime">Prezime</label>
		      <input id="prezime" name="prezime" type="text" value="<?php echo e($userInfo->prezime); ?>" placeholder="Prezime" class="form-control" required>
		    </div>
		  </div>
		  <div class="form-row">
		    <div class="form-group col-md-8">
		    	<label for="email">Email</label>
		    	<input id="email" name="email" type="email" value="<?php echo e($userInfo->email); ?>" placeholder="primjer@primjer.com" class="form-control" required>
		  	</div>
		  ...
		  <div class="form-row">
		    <div class="form-group col-md-5">
		      ...
		      <input id="telefon" name="telefon" type="number" min="0" oninput="validity.valid||(value='');" value="<?php echo e($userInfo->telefon); ?>" placeholder="Telefon" class="form-control">
		    </div>
		    <div class="form-group col-md-5">
		      <label for="adresa">Adresa</label>
		      <input id="adresa" name="adresa" type="text" value="<?php echo e($userInfo->adresa); ?>" placeholder="Adresa" class="form-control">
		    </div>
		    <div class="form-group col-md-2">
		      <label for="pbroj">Poštanski broj</label>
		      <input id="pbroj" name="pbroj" type="number" min="0" oninput="validity.valid||(value='');" value="<?php echo e($userInfo->pbroj); ?>" placeholder="Poštanski broj" class="form-control">
		    </div>
		  </div>
		</form>
		<hr>
	  ...
	  <div class="tab-pane fade" id="nacin" role="tabpanel" aria-labelledby="nacin-tab">
	  	<a class="btn btn-outline-success btn-round btnPrevious hiddenTab">Blagajna <i class="fas fa-arrow-right"></i></a> <!-- skriveni -->
	  	<span>Prije finaliziranja prodaje molimo vas da pročitate naše <a href="">opće uvjete korištenja.</a></span><br><br>
...
</html><?php /**PATH D:\XAMPP\htdocs\Diplomski\resources\views/cart.blade.php ENDPATH**/ ?>