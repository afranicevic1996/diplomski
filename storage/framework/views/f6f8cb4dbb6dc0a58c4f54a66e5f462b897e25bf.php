 ...
 <div class="row">
  <div class="col-lg-12">
    <div class="center">
      ...
      <center>Unesite kod za povrat zaporke sa vašeg emaila: <b><?php echo e($email); ?></b></center>
      <form id="resetPassword" style="display: inline;" method="POST" action="/checkKod">
        <?php echo csrf_field(); ?>
        <div class="form-row">
          <div class="form-group col-md-3">
            <input type="text" name="username" placeholder="Korisničko ime" value="<?php echo e($username); ?>" id="username" class="podaci form-control" required>
          </div>

          <div class="form-group col-md-3">
            <input type="email" name="email" placeholder="Email" value="<?php echo e($email); ?>" id="email" class="podaci form-control" required>
          </div>
  ...
  $(document).ready(function(){
    ...
    $(".check").click(function(){
      ...
      request.done(function (response, textStatus, jqXHR){
        ...
        if(data.status == 1){
          var htmlTekst = "<hr><form id='changePassword' method='post' action='/changePassword'><input name='_token' value='<?php echo e(csrf_token()); ?>' type='hidden'><input type='hidden' name='email' class='podaci' value='"+email+"'><input type='hidden' name='kod' class='podaci' value='"+kod+"'><input type='hidden' name='username' class='podaci' value='"+username+"'><input type='text' id='password' name='password' placeholder='Upišite novi password' class='form-control' required><div class='invalid-feedback'></div><br><input type='text' id='password2' name='password2' placeholder='Potvrdite novi password' class='form-control' required><div class='invalid-feedback'></div></form><button id='potvrdi' type='submit' class='btn btn-outline-primary'>Pošalji</button>";
...
</html><?php /**PATH C:\xampp\htdocs\Diplomski\resources\views/resetPassword.blade.php ENDPATH**/ ?>